# CODE LOCATION: jarvis-assistant/main.py (FINAL VERSION with Archival Skills)
...
from skills.yt_tools import yt_inspect, yt_summarize # YouTube Inspection skills
from skills.yt_tools_archival import yt_saveaudio, yt_savevideo # YouTube Archival skills <--- NEW IMPORT
...
# -------------------------------------------------------------
## NEW SKILL: YouTube Audio Archival (Heavy Download)
# -------------------------------------------------------------
...
def handle_yt_saveaudio(command):
    ...
    # Call the actual skill function
...
# -------------------------------------------------------------
## NEW SKILL: YouTube Video Archival (Heavy Download)
# -------------------------------------------------------------
...
SKILL_MAP = {
    ...
    # NEW YOUTUBE ARCHIVAL SKILLS (Heavy) <--- ADDED
    ...
    # YOUTUBE INSPECTION/TRANSCRIPT SKILLS
